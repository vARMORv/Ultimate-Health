...
void GameloopHooked() {
	...
	if (!IsInitialized && SAMP::IsSAMPInitialized()) {
		...
		case (SAMP::sampVersion::R1): {
			...
			PlayerTags__HealthHook = std::make_unique<memwrapper::memhook<CPlayerTags__Prototype>>(SAMP::GetSAMPHandle() + 0x689C0, &CPlayerTagHook);
		...
		case (SAMP::sampVersion::R2): {
			...
			PlayerTags__HealthHook = std::make_unique<memwrapper::memhook<CPlayerTags__Prototype>>(SAMP::GetSAMPHandle() + 0x68A90, &CPlayerTagHook);
			PlayerTags__HealthHook->install();
			break;
		}
		case (SAMP::sampVersion::R3): {
			...
			PlayerTags__HealthHook = std::make_unique<memwrapper::memhook<CPlayerTags__Prototype>>(SAMP::GetSAMPHandle() + 0x6C930, &CPlayerTagHook);
			PlayerTags__HealthHook->install();
			break;
		}
		case (SAMP::sampVersion::R4): {
			...
			PlayerTags__HealthHook = std::make_unique<memwrapper::memhook<CPlayerTags__Prototype>>(SAMP::GetSAMPHandle() + 0x6D060, &CPlayerTagHook);
			PlayerTags__HealthHook->install();
			break;
		...
		case (SAMP::sampVersion::DL): {
			...
			PlayerTags__HealthHook = std::make_unique<memwrapper::memhook<CPlayerTags__Prototype>>(SAMP::GetSAMPHandle() + 0x6CAE0, &CPlayerTagHook);
			PlayerTags__HealthHook->install();
			break;
		}
		default: {
